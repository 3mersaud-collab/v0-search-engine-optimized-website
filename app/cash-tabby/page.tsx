  ...
  "@graph": [
    {
      ...
      name: "كاش تابي",
      description: "صفحة مخصصة لكلمة كاش تابي وتشرح آلية تحويل رصيد تابي إلى نقد عبر خطوات واضحة وسريعة.",
      provider: { "@type": "LocalBusiness", "@id": "https://liilsol.com/#business" },
      areaServed: { "@type": "Country", name: "Saudi Arabia" },
      serviceType: ["كاش تابي", "tabby cash", "تحويل رصيد تابي إلى نقد"],
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
...
const highlights = [
  {
    ...
    desc: "إذا كان لديك حد شراء في تابي، يمكن الاستفادة منه للحصول على نقد فعلي بدلاً من بقائه كرصيد شرائي فقط.",
  },
  {
    icon: ArrowRightLeft,
...
const faqs = [
  ...
  },
  {
    ...
    a: "غالباً نعم، لكن هذه الصفحة تستهدف من يبحث بصيغة كاش تابي تحديدًا، بينما توجد صفحات أخرى تغطي نفس الخدمة بصيغ بحث مختلفة.",
  },
  {
