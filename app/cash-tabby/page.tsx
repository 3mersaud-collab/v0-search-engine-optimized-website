...
const highlights = [
  {
    ...
    desc: "إذا كان لديك حد شراء في تابي، يمكن الاستفادة منه للحصول على سيولة نقدية بدل بقائه كرصد شرائي فقط.",
  },
  {
    icon: ArrowRightLeft,
...
const faqs = [
  ...
  },
  {
    ...
    a: "نعم، في الغالب يستخدم العملاء المصطلحين لنفس الفكرة مع اختلاف التسمية فقط.",
  },
  {
