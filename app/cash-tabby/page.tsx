...
q: "هل كاش تابي هو نفسه تسييل تابي؟",
  ...
  {
    q: "كم يستغرق تحويل المبلغ؟",
    a: "نحول المبلغ لحسابك خلال ساعة من دفع الدفعة الأولى. وفي حال أي تأخير من طرفنا نعوّضك 25 ريال عن كل ساعة تأخير.",
  },
]
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="gap-2" asChild>
                  <a href="https://wa.me/966544610485?text=أبي كاش تابي" target="_blank" rel="noopener noreferrer">
                    اطلب كاش تابي الآن
