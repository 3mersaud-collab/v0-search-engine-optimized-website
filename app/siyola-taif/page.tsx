...
export const metadata: Metadata = {
  title: "سيولة تابي الطائف | كاش تمارا الطائف — مطر",
  description: "سيولة تابي الطائف وكاش تمارا الطائف — نحوّل رصيدك إلى كاش في حسابك البنكي خلال ساعة. خدمة مطر لأهل الطائف بدون تحويل راتب.",
  keywords: "سيولة تابي الطائف, كاش تمارا الطائف, سيولة في الطائف, سلفة الطائف, تسييل تابي الطائف, كاش تابي الطائف",
  alternates: {
    canonical: "https://liilsol.com/siyola-taif",
  },
  openGraph: {
    title: "سيولة تابي الطائف | كاش تمارا الطائف — مطر",
    description: "سيولة تابي الطائف وكاش تمارا الطائف — نحوّل رصيدك إلى كاش في حسابك البنكي خلال ساعة. خدمة مطر لأهل الطائف بدون تحويل راتب.",
    url: "https://liilsol.com/siyola-taif",
    locale: "ar_SA",
    type: "website",
  },
}
...
const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      "@id": "https://liilsol.com/siyola-taif#local",
      name: "مطر — سيولة تابي وكاش تمارا الطائف",
      description: "سيولة تابي الطائف وكاش تمارا الطائف — نحوّل رصيدك إلى كاش في حسابك البنكي خلال ساعة. خدمة مطر لأهل الطائف بدون تحويل راتب.",
      url: "https://liilsol.com/siyola-taif",
      ...
      serviceType: ["سيولة تابي", "كاش تمارا", "سيولة في الطائف"],
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "الرئيسية", item: "https://liilsol.com" },
        { "@type": "ListItem", position: 2, name: "سيولة الطائف", item: "https://liilsol.com/siyola-taif" },
      ],
    },
    {
      "@type": "FAQPage",
      mainEntity: [
        {
          "@type": "Question",
          name: "هل خدمة مطر متاحة في الطائف؟",
          acceptedAnswer: {
            "@type": "Answer",
            text: "نعم، خدمة مطر متاحة لجميع مناطق المملكة بما فيها الطائف. العملية تتم عبر المتاجر الإلكترونية ولا تحتاج حضوراً.",
          },
        },
        {
          "@type": "Question",
          name: "كم يستغرق التحويل لأهل الطائف؟",
          acceptedAnswer: {
            "@type": "Answer",
...
const features = [
  ...
  { icon: MapPin, title: "متاح في الطائف", desc: "الخدمة إلكترونية بالكامل — تنفذ من أي مكان" },
      ...
      <main className="flex-1">
        ...
        <section className="py-16 md:py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative">
            <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
              ...
              <span className="text-foreground">سيولة الطائف</span>
            </nav>
            <div className="max-w-3xl">
              <div className="flex items-center gap-2 mb-4">
                <MapPin className="h-5 w-5 text-primary" />
                <span className="text-primary font-medium">الطائف</span>
              </div>
              <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
                سيولة تابي الطائف
                <span className="block text-2xl md:text-3xl text-muted-foreground font-normal mt-2">
                  وكاش تمارا الطائف — تحويل خلال ساعة
                </span>
              </h1>
        ...
        <section className="py-16 bg-muted/30">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-12">
              خطوات سيولة تابي الطائف مع مطر
            </h2>
        ...
        <section className="py-16 bg-muted/30">
          <div className="container mx-auto px-4 max-w-3xl">
            <h2 className="text-2xl font-bold mb-8">أسئلة شائعة — سيولة الطائف</h2>
            <div className="space-y-4">
              {[
                {
                  q: `هل خدمة مطر متاحة في الطائف؟`,
                  a: `نعم، خدمة مطر متاحة لجميع مناطق المملكة بما فيها الطائف. العملية تتم عبر المتاجر الإلكترونية ولا تحتاج حضوراً أو توصيلاً.`,
                },
                {
                  q: `كم يستغرق تحويل سيولة تابي الطائف؟`,
                  a: `التحويل يتم خلال ساعة فقط من إرسالك للشاشة على واتساب، بغض النظر عن المدينة.`,
                },
                {
                  q: `هل أحتاج تحويل راتب للحصول على سيولة تابي الطائف؟`,
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-2xl font-bold mb-4">ابدأ سيولتك من الطائف الآن</h2>
