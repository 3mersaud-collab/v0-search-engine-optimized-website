...
export const metadata: Metadata = {
  title: "سلفة تمارا | كاش من رصيد تمارا في حسابك خلال ساعة | مطر",
  description:
    "تريد سلفة من رصيد تمارا؟ نحوّله كاش نقدي مباشرة لحسابك البنكي. خطوة واحدة منك — الباقي علينا. بدون تحويل راتب ولا أي تعقيد.",
  keywords:
  ...
  openGraph: {
    title: "سلفة تمارا | كاش من رصيد تمارا في حسابك خلال ساعة | مطر",
    description: "تريد سلفة من رصيد تمارا؟ نحوّله كاش نقدي مباشرة لحسابك. خطوة واحدة منك — الباقي علينا. بدون تحويل راتب ولا تعقيد.",
