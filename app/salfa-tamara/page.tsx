...
export const metadata: Metadata = {
  title: "سلفة تمارا | شرح السلفة على رصيد تمارا | مطر",
  description:
    "صفحة سلفة تمارا مخصصة لمن يبحث بهذه الصيغة تحديدًا ويريد فهم طريقة الحصول على نقد من رصيد تمارا بخطوات واضحة، مع فصلها عن صفحة كاش تمارا لتقليل التداخل.",
  keywords:
    "سلفة تمارا, سلفة من تمارا, طلب سلفة تمارا, سلفة على رصيد تمارا, tamara سلفة",
  alternates: {
    canonical: "https://liilsol.com/salfa-tamara",
  },
  openGraph: {
    title: "سلفة تمارا | طريقة الحصول على سلفة من تمارا | مطر",
    description: "تعرف على معنى سلفة تمارا والطريقة المناسبة لطلبها بخطوات واضحة ومباشرة.",
  ...
  "@graph": [
    {
      ...
      name: "سلفة تمارا",
      description: "صفحة مخصصة لشرح سلفة تمارا وطريقة تحويل الرصيد المتاح في التطبيق إلى نقد عبر نظام شراكة واضح.",
      provider: { "@type": "LocalBusiness", "@id": "https://liilsol.com/#business" },
      areaServed: { "@type": "Country", name: "Saudi Arabia" },
      serviceType: ["سلفة تمارا", "سلفة من تمارا", "طلب سلفة على تمارا"],
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: { "@type": "Answer", text: "الهدف العام متقارب، لكن هذه الصفحة مخصصة لمن يبحث عن سلفة تمارا تحديدًا، بينما توجد صفحة منفصلة لعبارات كاش تمارا وسيولة تمارا لتغطية نيات بحث مختلفة." },
        },
        {
          "@type": "Question",
...
const faqs = [
  { q: "ما الفرق بين سلفة تمارا وكاش تمارا؟", a: "أصل الخدمة متقارب، لكن هذه الصفحة موجهة لعبارة سلفة تمارا تحديدًا، بينما صفحة كاش تمارا تستهدف من يبحث بصيغة الكاش أو السيولة." },
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-3xl md:text-5xl font-extrabold leading-tight mb-6 text-foreground">
                سلفة تمارا
                <span className="block text-primary mt-2">شرح السلفة على رصيد تمارا بخطوات واضحة ⚡</span>
              </h1>
