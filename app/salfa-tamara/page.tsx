...
const faqs = [
  ...
  { q: "كم يستغرق تحويل المبلغ؟", a: "نحول المبلغ لحسابك خلال ساعة من دفع الدفعة الأولى. وفي حال أي تأخير من طرفنا نعوّضك 25 ريال عن كل ساعة تأخير." },
]
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <Button size="lg" className="gap-2 text-lg shadow-lg shadow-primary/20" asChild>
                  <a href="https://wa.me/966568037324?text=أبي سلفة تمارا" target="_blank" rel="noopener noreferrer">
