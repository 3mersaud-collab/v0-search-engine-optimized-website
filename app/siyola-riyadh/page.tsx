...
export const metadata: Metadata = {
  ...
  description:
"احصل على سيولة تابي الرياض وكاش تمارا الرياض خلال ساعة من دفع الدفعة الأولى. مطر يدخل معك كشريك في الشراء من المتاجر المتاحة ثم يحوّل لك الصافي مباشرة لحسابك البنكي.",
  keywords:
...
const faqs = [
  ...
  {
    q: "كم وقت تحويل سيولة تابي الرياض؟",
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <Button size="lg" className="gap-2 text-lg shadow-lg shadow-primary/20" asChild>
                  <a
                    href="https://wa.me/966544610485?text=أريد سيولة تابي أو كاش تمارا في الرياض"
                    target="_blank"
