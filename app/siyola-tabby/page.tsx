...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "خلال ساعة من دفع الدفعة الأولى إلى التحويل الكامل لحسابك البنكي. وفي حال التأخير نلتزم بتعويضك 25 ريال عن كل ساعة تأخير.",
      },
    },
    {
      "@type": "Question",
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <Button size="lg" className="gap-2 text-lg shadow-lg shadow-primary/20" asChild>
                  <a href="https://wa.me/966557002147" target="_blank" rel="noopener noreferrer">
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    a: "من وقت دفع الدفعة الأولى إلى وصول المبلغ لحسابك البنكي، الوقت المعتاد لا يتجاوز ساعة واحدة. وفي حال التأخير نلتزم بتعويضك 25 ريال عن كل ساعة تأخير.",
                  },
                  {
              ...
              <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-5">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "التحويل في ساعة — من دفع الدفعة الأولى إلى استلام الكاش.",
                    color: "text-accent",
                  },
                  {
                    icon: Users,
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-muted-foreground mb-2 text-lg">
                تواصل معنا الآن على واتساب وستستلم كاشك في حسابك خلال ساعة من دفع الدفعة الأولى
              </p>
