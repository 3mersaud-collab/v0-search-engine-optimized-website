...
export const metadata: Metadata = {
  ...
  description:
    "احصل على سيولة تابي وكاش من رصيدك خلال ساعة. سلفة تابي بأفضل الأسعار في السعودية. تحويل رصيد تابي إلى نقد في حسابك البنكي بدون تحويل راتب. خدمة في الرياض وجدة والدمام.",
  keywords:
    "سيولة تابي, كاش تابي, سلفة تابي, تحويل رصيد تابي, كيف احول رصيد تابي الى كاش, سيولة تابي بدون تحويل راتب, تسييل تابي, tabby cash, سيولة من تابي",
  alternates: {
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "نعم آمنة 100%. نحن لا نطلب كلمات مرور أو رموز OTP مطلقًا. أنت تتحكم في كل خطوة من هاتفك الشخصي.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "الرسوم الإدارية 10% من قيمة الشراء، إضافةً لفرق البيع الذي يتراوح بين 10-15% حسب المبلغ. كلما زاد المبلغ قلّت النسبة.",
      },
    },
  ],
}
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="gap-2 text-lg shadow-xl shadow-primary/25" asChild>
                  <a href="https://wa.me/966590360039" target="_blank" rel="noopener noreferrer" aria-label="تواصل معنا عبر واتساب على الرقم 0590360039">
                    واتساب: 0590360039
                    <ArrowLeft className="w-5 h-5" />
                  </a>
                </Button>
