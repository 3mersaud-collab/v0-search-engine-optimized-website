...
export const metadata: Metadata = {
  title: "سيولة تابي | كاش فوري بدون دفعة أولى خلال ساعة | مطر",
  description:
    "احصل على سيولة تابي وكاش فوري خلال ساعة مع مطر. بدون دفعة أولى من جيبك، خطوات واضحة، حاسبة صافي، وخدمة موثوقة في الرياض وجدة والدمام وجميع مناطق السعودية.",
  keywords:
  ...
  openGraph: {
    title: "سيولة تابي | كاش فوري بدون دفعة أولى خلال ساعة | مطر",
    description:
      "حوّل رصيد تابي إلى كاش فوري مع مطر. بدون دفعة أولى من جيبك، بدون تحويل راتب، وخطوات واضحة خلال ساعة.",
