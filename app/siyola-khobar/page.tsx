...
export const metadata: Metadata = {
  title: "سيولة تابي الخبر | كاش تمارا الخبر — مطر",
  description: "سيولة تابي الخبر وكاش تمارا الخبر — نحوّل رصيدك إلى كاش في حسابك البنكي خلال ساعة. خدمة مطر لأهل الخبر والمنطقة الشرقية.",
  keywords: "سيولة تابي الخبر, كاش تمارا الخبر, سيولة في الخبر, سلفة الخبر, تسييل تابي الخبر, سيولة المنطقة الشرقية",
  alternates: {
    canonical: "https://liilsol.com/siyola-khobar",
  },
  openGraph: {
    title: "سيولة تابي الخبر | كاش تمارا الخبر — مطر",
    description: "سيولة تابي الخبر وكاش تمارا الخبر — نحوّل رصيدك إلى كاش في حسابك البنكي خلال ساعة. خدمة مطر لأهل الخبر والمنطقة الشرقية.",
    url: "https://liilsol.com/siyola-khobar",
    locale: "ar_SA",
    type: "website",
  },
}
...
const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      "@id": "https://liilsol.com/siyola-khobar#local",
      name: "مطر — سيولة تابي وكاش تمارا الخبر",
      description: "سيولة تابي الخبر وكاش تمارا الخبر — نحوّل رصيدك إلى كاش في حسابك البنكي خلال ساعة. خدمة مطر لأهل الخبر والمنطقة الشرقية.",
      url: "https://liilsol.com/siyola-khobar",
      ...
      serviceType: ["سيولة تابي", "كاش تمارا", "سيولة في الخبر"],
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "الرئيسية", item: "https://liilsol.com" },
        { "@type": "ListItem", position: 2, name: "سيولة الخبر", item: "https://liilsol.com/siyola-khobar" },
      ],
    },
    {
      "@type": "FAQPage",
      mainEntity: [
        {
          "@type": "Question",
          name: "هل خدمة مطر متاحة في الخبر؟",
          acceptedAnswer: {
            "@type": "Answer",
            text: "نعم، خدمة مطر متاحة لجميع مناطق المملكة بما فيها الخبر. العملية تتم عبر المتاجر الإلكترونية ولا تحتاج حضوراً.",
          },
        },
        {
          "@type": "Question",
          name: "كم يستغرق التحويل لأهل الخبر؟",
          acceptedAnswer: {
            "@type": "Answer",
...
const features = [
  ...
  { icon: MapPin, title: "متاح في الخبر", desc: "الخدمة إلكترونية بالكامل — تنفذ من أي مكان" },
      ...
      <main className="flex-1">
        ...
        <section className="py-16 md:py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative">
            <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
              ...
              <span className="text-foreground">سيولة الخبر</span>
            </nav>
            <div className="max-w-3xl">
              <div className="flex items-center gap-2 mb-4">
                <MapPin className="h-5 w-5 text-primary" />
                <span className="text-primary font-medium">الخبر</span>
              </div>
              <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
                سيولة تابي الخبر
                <span className="block text-2xl md:text-3xl text-muted-foreground font-normal mt-2">
                  وكاش تمارا الخبر — تحويل خلال ساعة
                </span>
              </h1>
        ...
        <section className="py-16 bg-muted/30">
          <div className="container mx-auto px-4 max-w-3xl">
            <h2 className="text-2xl font-bold mb-8">أسئلة شائعة — سيولة الخبر</h2>
            <div className="space-y-4">
              {[
                {
                  q: `هل خدمة مطر متاحة في الخبر؟`,
                  a: `نعم، خدمة مطر متاحة لجميع مناطق المملكة بما فيها الخبر. العملية تتم عبر المتاجر الإلكترونية ولا تحتاج حضوراً أو توصيلاً.`,
                },
                {
                  q: `كم يستغرق تحويل سيولة تابي الخبر؟`,
                  a: `التحويل يتم خلال ساعة فقط من إرسالك للشاشة على واتساب، بغض النظر عن المدينة.`,
                },
                {
                  q: `هل أحتاج تحويل راتب للحصول على سيولة تابي الخبر؟`,
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-2xl font-bold mb-4">ابدأ سيولتك من الخبر الآن</h2>
