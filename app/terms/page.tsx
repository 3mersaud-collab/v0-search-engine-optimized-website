...
export const metadata: Metadata = {
  ...
  description:
    "الشروط والأحكام لخدمات مطر - سيولة نقدية فورية. رسوم إدارية 10% (+ 100 ر.س للمبالغ أقل من 4,000 ر.س) بدون رسوم مخفية. متوافق مع نظام حماية البيانات الشخصية السعودي PDPL.",
}
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              ...
              <div className="bg-card rounded-2xl p-8 border border-border">
                ...
                <ul className="text-muted-foreground space-y-3 list-disc list-inside">
                  ...
                  <li>
                    <strong>الشفافية الكاملة:</strong> {"جميع الرسوم محسوبة ومعروضة مسبقاً في الحاسبة — بدون أي رسوم مخفية"}
                  </li>
                  <li>
