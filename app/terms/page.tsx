...
export const metadata: Metadata = {
  title: "الشروط والأحكام | شروط خدمة السيولة والتورق",
  description:
    "الشروط والأحكام لخدمات مطر - سيولة نقدية فورية عبر التورق الشرعي المباح. رسوم شفافة 10-14% بدون رسوم مخفية. متوافق مع نظام حماية البيانات الشخصية السعودي PDPL.",
}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center text-muted-foreground mb-12">
              {"شروط استخدام خدمات السيولة النقدية والسلفة عبر التورق الشرعي المباح"}
            </p>
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              <div className="bg-card rounded-2xl p-8 border border-border">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  {"مرحبا بك في مطر. باستخدامك لخدماتنا، فإنك توافق على الالتزام بهذه الشروط والأحكام. نقدم خدمة سيولة نقدية فورية عبر آلية التورق المباح شرعا (وفقا لفتاوى هيئة كبار العلماء وابن باز وابن عثيمين)، وذلك بالدخول كشركاء معكم في شراء الأجهزة عبر تابي وتمارا ومدفوع ثم بيعها لطرف ثالث مستقل وتحويل السيولة لكم."}
                </p>
              </div>
              ...
              <div className="bg-card rounded-2xl p-8 border border-border">
                ...
                <ul className="text-muted-foreground space-y-3 list-disc list-inside">
                  <li>
                    نقدم خدمة سيولة نقدية وسلفة فورية عبر التورق الشرعي المباح
                  </li>
                  <li>
              ...
              <div className="bg-card rounded-2xl p-8 border border-border">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  يتم تحويل السيولة لحسابك البنكي عادة خلال ساعتين من إتمام العملية عبر التورق الشرعي. هذه المدة تقريبية وقد تختلف بحسب عوامل خارجية مثل: أوقات معالجة البنوك، تأخر التطبيقات، أو أيام العطل الرسمية. لا نضمن وقتا محددا بالدقيقة لكن نلتزم بأسرع تنفيذ ممكن.
                </p>
              </div>
              ...
              <div className="bg-card rounded-2xl p-8 border border-border">
                ...
                <ul className="text-muted-foreground space-y-3 list-disc list-inside">
                  <li>
                    تنفيذ الطلب بأسرع وقت ممكن (عادة خلال ساعتين)
                  </li>
                  <li>
