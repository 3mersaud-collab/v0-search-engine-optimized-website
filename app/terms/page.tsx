          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              ...
              <div className="bg-card rounded-2xl p-8 border border-border">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  يتم تحويل السيولة لحسابك البنكي عادة خلال ساعتين من اتمام العملية. هذه المدة تقريبية وقد تختلف بحسب عوامل خارجية مثل: اوقات معالجة البنوك، تأخر التطبيقات، أو أيام العطل الرسمية. لا نضمن وقتا محددا بالدقيقة لكن نلتزم بأسرع تنفيذ ممكن.
                </p>
              </div>
