            ...
            <div className="prose prose-lg max-w-none space-y-8">
              <div className="bg-card rounded-2xl p-8 border border-border">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  {"مرحبا بك في مطر. باستخدامك لخدماتنا، فإنك توافق على الالتزام بهذه الشروط والأحكام. نقدم خدمة سيولة نقدية فورية بالدخول كشركاء معكم في شراء الأجهزة عبر تابي وتمارا ثم بيعها لطرف ثالث مستقل وتحويل السيولة لكم."}
                </p>
              </div>
              ...
              <div className="bg-card rounded-2xl p-8 border border-border">
                ...
                <ul className="text-muted-foreground space-y-3 list-disc list-inside">
                  ...
                  <li>
                    ندخل كشركاء معكم في شراء الأجهزة من المتاجر الإلكترونية (نون / اكسترا / ) عبر رصيدك في تابي أو تمارا
                  </li>
                  <li>
                  ...
                  <li>
                    أنت المسؤول عن سداد الأقساط المتبقية للتطبيق المستخدم (تابي / تمارا / )
                  </li>
                  <li>
