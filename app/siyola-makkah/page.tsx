...
export const metadata: Metadata = {
  title: "سيولة تابي مكة المكرمة | كاش تمارا مكة — مطر",
  description: "سيولة تابي مكة المكرمة وكاش تمارا مكة — نحوّل رصيدك إلى كاش في حسابك البنكي خلال ساعة. خدمة مطر متاحة لأهل مكة بدون تحويل راتب.",
  keywords: "سيولة تابي مكة, كاش تمارا مكة, سيولة في مكة المكرمة, سلفة مكة, تسييل تابي مكة, كاش تابي مكة المكرمة",
  alternates: {
    canonical: "https://liilsol.com/siyola-makkah",
  },
  openGraph: {
    title: "سيولة تابي مكة المكرمة | كاش تمارا مكة — مطر",
    description: "سيولة تابي مكة المكرمة وكاش تمارا مكة — نحوّل رصيدك إلى كاش في حسابك البنكي خلال ساعة. خدمة مطر متاحة لأهل مكة بدون تحويل راتب.",
    url: "https://liilsol.com/siyola-makkah",
    locale: "ar_SA",
    type: "website",
  },
}
...
const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      "@id": "https://liilsol.com/siyola-makkah#local",
      name: "مطر — سيولة تابي وكاش تمارا مكة المكرمة",
      description: "سيولة تابي مكة المكرمة وكاش تمارا مكة — نحوّل رصيدك إلى كاش في حسابك البنكي خلال ساعة. خدمة مطر متاحة لأهل مكة بدون تحويل راتب.",
      url: "https://liilsol.com/siyola-makkah",
      ...
      serviceType: ["سيولة تابي", "كاش تمارا", "سيولة في مكة"],
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "الرئيسية", item: "https://liilsol.com" },
        { "@type": "ListItem", position: 2, name: "سيولة مكة", item: "https://liilsol.com/siyola-makkah" },
      ],
    },
    {
      "@type": "FAQPage",
      mainEntity: [
        {
          "@type": "Question",
          name: "هل خدمة مطر متاحة في مكة المكرمة؟",
          acceptedAnswer: {
            "@type": "Answer",
            text: "نعم، خدمة مطر متاحة لجميع مناطق المملكة بما فيها مكة المكرمة. العملية تتم عبر المتاجر الإلكترونية ولا تحتاج حضوراً.",
          },
        },
        {
          "@type": "Question",
          name: "كم يستغرق التحويل لأهل مكة؟",
          acceptedAnswer: {
            "@type": "Answer",
...
const features = [
  ...
  { icon: MapPin, title: "متاح في مكة المكرمة", desc: "الخدمة إلكترونية بالكامل — تنفذ من أي مكان" },
      ...
      <main className="flex-1">
        ...
        <section className="py-16 md:py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative">
            <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
              ...
              <span className="text-foreground">سيولة مكة</span>
            </nav>
            <div className="max-w-3xl">
              <div className="flex items-center gap-2 mb-4">
                <MapPin className="h-5 w-5 text-primary" />
                <span className="text-primary font-medium">مكة المكرمة</span>
              </div>
              <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
                سيولة تابي مكة
                <span className="block text-2xl md:text-3xl text-muted-foreground font-normal mt-2">
                  وكاش تمارا مكة — تحويل خلال ساعة
                </span>
              </h1>
        ...
        <section className="py-16 bg-muted/30">
          <div className="container mx-auto px-4 max-w-3xl">
            <h2 className="text-2xl font-bold mb-8">أسئلة شائعة — سيولة مكة</h2>
            <div className="space-y-4">
              {[
                {
                  q: `هل خدمة مطر متاحة في مكة المكرمة؟`,
                  a: `نعم، خدمة مطر متاحة لجميع مناطق المملكة بما فيها مكة المكرمة. العملية تتم عبر المتاجر الإلكترونية ولا تحتاج حضوراً أو توصيلاً.`,
                },
                {
                  q: `كم يستغرق تحويل سيولة تابي مكة؟`,
                  a: `التحويل يتم خلال ساعة فقط من إرسالك للشاشة على واتساب، بغض النظر عن المدينة.`,
                },
                {
                  q: `هل أحتاج تحويل راتب للحصول على سيولة تابي مكة؟`,
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-2xl font-bold mb-4">ابدأ سيولتك من مكة المكرمة الآن</h2>
