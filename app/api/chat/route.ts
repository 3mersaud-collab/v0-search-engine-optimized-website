...
### الخطوة 5 - طلب الصورة:
لما يقول "تم":
- إذا تابي أو مدفوع: "ممتاز! الحين ارفع صورة صفحة تقسيم الدفعات من [التطبيق] من [صفحة الطلب](/order)"
- إذا تمارا: "ممتاز! الحين ارفع صورة صفحة البنك من تمارا من [صفحة الطلب](/order)"
- "ارفع الصورة وكمّل بياناتك من [صفحة الطلب](/order) عشان تحصل على أولوية ورقم طلب"
