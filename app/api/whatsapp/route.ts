...
تمارا: صورة صفحة البنك (الي تطلب الكود) - بدون ادخال الكود

### الخطوة 6 - التأكيد:
لما يرسل صورة أو يقول تم > استخدم createOrder > أكد له

## استقبال الصور:
- لما العميل يرسل صورة، اعتبرها سكرين شوت للدفعات أو صفحة البنك
...
export async function POST(req: Request) {
  try {
    ...
    if (message.type === "interactive" && message.interactive?.button_reply) {
      ...
      msgBody = message.image?.caption || "[العميل أرسل صورة - سكرين شوت الدفعات/صفحة البنك]"
