...
3. العميل يروح المتجر (اكسترا/نون/) ويشتري الجهاز عن طريق تابي أو تمارا
...
## الضمان:
خدمة موثوقة وعمليات تتعدى 100 ألف بكل شفافية. موقعنا: https://liilsol.com
      ...
      tools: {
        ...
        createOrder: tool({
          ...
          inputSchema: z.object({
            ...
            appType: z.string().describe("تابي/تمارا/"),
