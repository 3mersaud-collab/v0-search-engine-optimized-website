  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        window.open(`https://wa.me/966568936966?text=${message}`, "_blank")
        setIsSubmitted(true)
      } else {
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-lg mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Button asChild><a href="https://wa.me/966568936966" target="_blank" rel="noopener noreferrer">فتح واتساب</a></Button>
