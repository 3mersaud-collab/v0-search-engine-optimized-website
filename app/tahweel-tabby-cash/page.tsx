...
export const metadata: Metadata = {
  title: "تحويل تابي إلى كاش | كيف تحول رصيد تابي إلى نقد | مطر",
  description:
    "حوّل رصيدك في تابي إلى كاش مباشرة في حسابك البنكي خلال ساعة — بدون تحويل راتب. خطوات بسيطة عبر واتساب.",
  keywords:
    "تحويل تابي إلى كاش, تحويل رصيد تابي كاش, تحويل رصيد تابي الى كاش, كيف احول رصيد تابي الى كاش, تحويل تابي نقد",
  alternates: {
    canonical: "https://liilsol.com/tahweel-tabby-cash",
  },
  openGraph: {
    title: "تحويل تابي إلى كاش | خطوات التحويل الواضحة | مطر",
    description: "تعرف على خطوات تحويل رصيد تابي إلى كاش وحساب الصافي بشكل واضح وسريع مع مطر.",
  ...
  "@graph": [
    {
      ...
      description: "صفحة متخصصة تشرح خدمة تحويل رصيد تابي إلى كاش وكيفية الحصول على الصافي عبر نظام شراكة واضح.",
      provider: { "@type": "LocalBusiness", "@id": "https://liilsol.com/#business" },
      areaServed: { "@type": "Country", name: "Saudi Arabia" },
      serviceType: ["تحويل تابي إلى كاش", "تحويل رصيد تابي كاش", "كيف احول رصيد تابي الى كاش"],
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
...
const howItWorks = [
  ...
  },
  {
    ...
    desc: "نبيع الجهاز ونحول لك الصافي مباشرة لحسابك البنكي. العملية كاملة خلال ساعة مع توضيح الصافي قبل الإكمال.",
  },
]
...
const faqs = [
  ...
  { q: "ما الفرق بين تحويل تابي إلى كاش وسيولة تابي؟", a: "الخدمة واحدة — نحوّل رصيدك في تابي إلى كاش في حسابك. سواء سمّيتها تحويل أو سيولة، النتيجة نفسها: كاش في حسابك خلال ساعة." },
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed max-w-2xl mx-auto">
                تبي تحوّل رصيدك في <strong className="text-foreground">تابي</strong> إلى نقد مباشرة في حسابك البنكي؟ معنا العملية كاملة خلال ساعة —
                تواصل، أرسل التأكيد، واستلم الكاش. <strong className="text-foreground">بدون تحويل راتب ولا ضامن.</strong>
              </p>
