...
export const metadata: Metadata = {
  ...
  description:
    "صفحة مخصصة لشرح كيف يتم تحويل تابي إلى كاش وكيف تحسب الصافي بخطوات واضحة وعملية دون حشو أو تكرار مشتت.",
  keywords:
...
const faqs = [
  ...
  { q: "ما الفرق بين تحويل تابي إلى كاش وسيولة تابي؟", a: "الفرق غالبًا في طريقة البحث فقط. هذه الصفحة مخصصة لشرح مسار التحويل نفسه خطوة بخطوة، بينما صفحة سيولة تابي تركّز على الخدمة الرئيسية بشكل أوسع." },
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed max-w-2xl mx-auto">
                ...
                مع التركيز على الأسئلة العملية مثل <strong className="text-foreground">كيف احول رصيد تابي الى كاش</strong> وحساب الصافي بصياغة طبيعية غير مبالغ فيها.
              </p>
