...
title: "كاش تمارا | سيولة تمارا وتحويل الرصيد إلى نقد خلال ساعة",
  description:
    "احصل على كاش تمارا وسيولة من رصيدك خلال ساعة واحدة فقط عبر نظام شراكة واضح. اعرف الخطوات المطلوبة وحساب الصافي قبل التنفيذ. الخدمة متاحة في الرياض وجدة والدمام وكل السعودية.",
  keywords:
...
name: "ما التعليمات المهمة عند الدفع عبر تمارا؟",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "تتم عملية تحويل كاش تمارا خلال ساعة واحدة فقط من وقت دفع الدفعة الأولى.",
      },
    },
    {
      "@type": "Question",
                ...
                <div className="space-y-4">
                  {[
                    ...
                    },
                    {
                      ...
                      a: "تتم عملية تحويل كاش تمارا خلال ساعة واحدة فقط من وقت دفع الدفعة الأولى. وفي حال التأخير نلتزم بدفع 25 ريال عن كل ساعة تأخير.",
                    },
                    {
