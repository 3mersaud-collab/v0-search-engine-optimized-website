...
title: "كاش تمارا | نقدك في حسابك خلال ساعة — بدون تعقيد | مطر",
  description:
    "حوّل رصيدك في تمارا إلى كاش نقدي خلال ساعة مع مطر. احسب مبلغك من الحاسبة، صوّر الشاشة، وأرسلها على واتساب — وابدأ فوراً.",
  keywords:
