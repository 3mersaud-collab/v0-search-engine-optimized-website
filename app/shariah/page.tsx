            ...
            <div className="bg-card rounded-2xl p-8 border border-border mb-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    {"وفقا لتقرير التمويل الإسلامي لعام 2025، فإن أكثر من 80% من البنوك السعودية تستخدم آلية التورق المباح كوسيلة لتوفير السيولة النقدية لعملائها، وذلك تحت إشراف ورقابة البنك المركزي السعودي (ساما). هذا يؤكد أن التورق آلية مالية معتمدة وآمنة عند استيفاء الشروط الشرعية، وهو ما نلتزم به في خدمات سيولة تابي وكاش تمارا."}
                  </p>
                </div>
              </div>
            </div>
