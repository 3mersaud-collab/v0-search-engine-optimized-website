            ...
            <div className="space-y-8">
              <div className="bg-card rounded-2xl p-8 border border-border">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  {"نلتزم في مطر بحماية خصوصية عملائنا وبياناتهم الشخصية وفقا لنظام حماية البيانات الشخصية السعودي (المرسوم الملكي رقم م/19 لعام 2021 المعدل 2023). توضح هذه السياسة كيف نجمع ونستخدم ونحمي بياناتك عند استخدام خدمات السيولة النقدية والسلفة الفورية عبر تابي وتمارا."}
                </p>
              </div>
