...
const whyNoSalary = [
  ...
  },
  {
    ...
    desc: "خلال ساعة من دفع الدفعة الأولى حتى وصول المبلغ لحسابك البنكي.",
  },
]
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <Button size="lg" className="gap-2 text-lg shadow-lg shadow-primary/20" asChild>
                  <a href="https://wa.me/966573777091?text=أبي سيولة بدون تحويل راتب" target="_blank" rel="noopener noreferrer">
                    اطلب سيولة الآن
