...
export const metadata: Metadata = {
  title: "سيولة بدون تحويل راتب | كاش فوري بدون شروط بنكية | مطر",
  description:
    "مو شرط تحوّل الراتب. إذا عندك رصيد في تابي أو تمارا، نحوّله كاش نقدي في حسابك خلال ساعة. بدون ضامن، بدون كفيل، بدون إجراءات.",
  keywords:
  ...
  openGraph: {
    title: "سيولة بدون تحويل راتب | كاش فوري بدون شروط بنكية | مطر",
    description: "مو شرط تحوّل الراتب. إذا عندك رصيد في تابي أو تمارا، نحوّله كاش نقدي في حسابك خلال ساعة. بدون ضامن ولا إجراءات.",
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <Button size="lg" className="gap-2 text-lg shadow-lg shadow-primary/20" asChild>
                  <a href="https://wa.me/966590360039?text=أبي سيولة بدون تحويل راتب" target="_blank" rel="noopener noreferrer">
                    اطلب سيولة الآن
