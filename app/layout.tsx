...
export const metadata: Metadata = {
  ...
  title: {
    default: 'مطر | سيولة تابي وتمارا - كاش فوري خلال ساعتين - سلفة تابي سلفة تمارا',
    template: '%s | مطر - سيولة تابي وتمارا'
  },
  description: 'مطر - سحابة غيث ماحسبت حسابها. نقوم بالدخول كشركاء معكم في شراء الجهاز عبر تابي وتمارا ومدفوع ونتكفل بالدفعة الأولى مقابل نسبة الشراكة ثم نبيعه ونحول لكم السيولة خلال ساعتين. كاش تابي، كاش تمارا، سلفة تابي، سلفة تمارا. أفضل خدمة سيولة في الرياض والسعودية.',
  keywords: [
    ...
    'مطر', 'liilsol', 'ليل سول', 'سحابة غيث',
    'tabby cash', 'tamara cash', 'tabby سيولة', 'tamara سيولة'
  ].join(', '),
  openGraph: {
    title: 'مطر | سيولة تابي وتمارا - كاش فوري وسلفة',
    description: 'مطر - سحابة غيث ماحسبت حسابها. نقوم بالدخول كشركاء معكم في شراء الجهاز ونتكفل بالدفعة الأولى مقابل نسبة الشراكة ثم نبيعه ونحول لكم السيولة خلال ساعتين.',
    locale: 'ar_SA',
    type: 'website',
