...
export const metadata: Metadata = {
  ...
  title: {
    default: 'مطر | سيولة تابي وكاش تمارا وسلفة خلال ساعة',
    template: '%s | مطر'
  },
  description: 'مطر — خدمة سيولة تابي وكاش تمارا وسلفة تابي وسلفة تمارا في السعودية عبر نظام شراكة واضح. احسب صافي المبلغ بالحاسبة ثم أكمل الطلب عبر واتساب. الخدمة متاحة في الرياض وجدة والدمام وجميع المناطق.',
  keywords: [
    'سيولة تابي',
    'كاش تابي',
    'سلفة تابي',
