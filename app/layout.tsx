...
export const metadata: Metadata = {
  ...
  title: {
    default: 'مطر | سيولة تابي وكاش تمارا خلال ساعة',
    template: '%s | مطر'
  },
  description: 'مطر — خدمة سيولة تابي وكاش تمارا في السعودية عبر نظام شراكة واضح. احسب صافي المبلغ بالحاسبة ثم أكمل الطلب عبر واتساب. الخدمة متاحة في الرياض وجدة والدمام وجميع المناطق.',
  keywords: [
    'سيولة تابي',
    'كاش تمارا',
    'تسييل تابي',
  ...
  openGraph: {
    title: 'مطر | سيولة تابي وكاش تمارا خلال ساعة',
    description: 'مطر — خدمة سيولة تابي وكاش تمارا في السعودية عبر نظام شراكة واضح، مع حاسبة لحساب الصافي ورسوم معروضة بشكل مباشر.',
    locale: 'ar_SA',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'مطر | سيولة تابي وكاش تمارا',
    description: 'مطر — خدمة سيولة تابي وكاش تمارا عبر نظام شراكة واضح وتحويل سريع بعد إكمال الخطوات.',
    images: ['/og-image.jpg']
  },
  alternates: {
