...
export const metadata: Metadata = {
  ...
  description: 'مطر - سحابة غيث ماحسبت حسابها. سيولة فورية من تابي وتمارا ومدفوع خلال ساعتين فقط. كاش تابي، كاش تمارا، سلفة تابي، سلفة تمارا. حول رصيدك إلى نقد في حسابك البنكي. أفضل خدمة سيولة في الرياض والسعودية.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'مطر - سحابة غيث ماحسبت حسابها. سيولة فورية من تابي وتمارا ومدفوع. تحويل فوري لحسابك البنكي خلال ساعتين.',
    locale: 'ar_SA',
    type: 'website',
  ...
  twitter: {
    ...
    description: 'مطر - سحابة غيث ماحسبت حسابها. سيولة فورية - كاش تابي - كاش تمارا - سلفة فورية خلال ساعتين.',
    images: ['/og-image.jpg']
  },
  alternates: {
