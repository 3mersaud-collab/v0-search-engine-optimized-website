...
export const metadata: Metadata = {
  title: "سيولة بدون بنك | حل أسرع وأبسط من أي إجراء بنكي | مطر",
  description:
    "ما تحتاج تروح للبنك ولا تنتظر الموافقات. رصيدك في تابي أو تمارا يتحوّل كاش نقدي في حسابك خلال ساعة — بدون إجراءات ولا أوراق.",
  keywords:
  ...
  openGraph: {
    title: "سيولة بدون بنك | حل أسرع وأبسط من أي إجراء بنكي | مطر",
    description: "ما تحتاج تروح للبنك. رصيدك في تابي أو تمارا يتحوّل كاش نقدي في حسابك خلال ساعة — بدون إجراءات ولا أوراق.",
