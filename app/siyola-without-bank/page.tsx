            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="gap-2" asChild>
                  <a href="https://wa.me/966550817121?text=أبي سيولة بدون بنك" target="_blank" rel="noopener noreferrer">
                    اطلب سيولة الآن
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto p-8 bg-card rounded-3xl border border-border text-center">
              ...
              <Button size="lg" className="gap-2" asChild>
                <a href="https://wa.me/966550817121?text=أبي تفاصيل سيولة بدون بنك" target="_blank" rel="noopener noreferrer">
                  تواصل عبر واتساب
                  <ArrowLeft className="w-5 h-5" />
                </a>
              </Button>
