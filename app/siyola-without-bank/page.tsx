...
export const metadata: Metadata = {
  ...
  description:
    "سيولة بدون بنك مع مطر لمن يبحث عن حل أسرع وأبسط من الإجراءات البنكية المعتادة، عبر الاستفادة من رصيد تابي أو تمارا وتحويله إلى نقد.",
  keywords:
...
const faqs = [
  ...
  },
  {
    ...
    a: "في هذا النوع من الخدمة، التركيز يكون على الرصيد المتاح في التطبيق وليس على تحويل الراتب كإجراء بنكي معتاد.",
  },
  {
