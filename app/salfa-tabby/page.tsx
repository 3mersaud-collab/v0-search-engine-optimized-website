...
export const metadata: Metadata = {
  ...
  description:
"سلفة تابي فورية تصل حسابك البنكي خلال ساعة من دفع الدفعة الأولى. نشتري معك كشركاء عبر تابي ونحول لك الصافي مباشرة بنظام واضح وخطوات معلنة.",
  keywords:
...
description: "حوّل رصيدك في تابي إلى سلفة نقدية تصل حسابك خلال ساعة من دفع الدفعة الأولى عبر خطوات واضحة ونظام شراكة منظم.",
  ...
  "@graph": [
    {
      ...
      description: "خدمة تحويل رصيد تابي إلى سلفة نقدية عبر نظام الشراكة الحلال. التحويل خلال ساعة من دفع الدفعة الأولى لأي حساب بنكي سعودي.",
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: { "@type": "Answer", text: "العملية كاملة تستغرق خلال ساعة من دفع الدفعة الأولى حتى وصول المبلغ لحسابك البنكي. وفي حال التأخير نلتزم بتعويضك 25 ريال عن كل ساعة تأخير." },
        },
        {
          "@type": "Question",
...
const benefits = [
  { icon: Clock, title: "تحويل خلال ساعة", desc: "خلال ساعة من دفع الدفعة الأولى حتى وصول المبلغ لحسابك" },
  ...
  { icon: Zap, title: "تنفيذ فوري", desc: "نبدأ مباشرة بعد استلام لقطة التحقق عبر واتساب" },
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <Button size="lg" className="gap-2 text-lg shadow-lg shadow-primary/20" asChild>
                  <a href="https://wa.me/966545263810?text=أبي سلفة تابي" target="_blank" rel="noopener noreferrer">
                    اطلب سلفة تابي الآن
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none text-muted-foreground leading-relaxed space-y-5">
                ...
                <p>
                  ما يميز الخدمة هو البساطة والسرعة: لا تحتاج زيارة مكتب أو تقديم أوراق. كل شيء يتم عن بُعد عبر واتساب، والمبلغ يصلك خلال ساعة من دفع الدفعة الأولى.
                </p>
                <p>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
                تواصل معنا الآن عبر واتساب وابدأ الخطوات. المبلغ يصل حسابك البنكي خلال ساعة من دفع الدفعة الأولى.
              </p>
