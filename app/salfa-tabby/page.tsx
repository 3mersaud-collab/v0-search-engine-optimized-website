  ...
  "@graph": [
    {
      ...
      name: "سلفة تابي",
      description: "صفحة تشرح معنى سلفة تابي وطريقة تحويل رصيد تابي إلى نقد عبر نظام شراكة واضح.",
      provider: { "@type": "LocalBusiness", "@id": "https://liilsol.com/#business" },
      areaServed: { "@type": "Country", name: "Saudi Arabia" },
      serviceType: ["سلفة تابي", "سلفة من تابي", "طلب سلفة على تابي"],
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
...
const faqs = [
  { q: "ما الفرق بين سلفة تابي وسيولة تابي؟", a: "غالباً المقصود واحد، لكن هذه الصفحة تستهدف من يبحث بكلمة سلفة تابي تحديدًا، بينما صفحات أخرى تشرح السيولة أو التحويل بصيغ مختلفة." },
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed max-w-2xl mx-auto">
                إذا كنت تبحث عن <strong className="text-foreground">سلفة من تابي</strong>، فهذه الصفحة تشرح لك المقصود بهذه الصيغة
                وكيف تبدأ بطريقة واضحة لتحويل الرصيد إلى نقد حقيقي. نوضح لك الآلية والخطوات قبل التنفيذ بشكل مباشر.
              </p>
