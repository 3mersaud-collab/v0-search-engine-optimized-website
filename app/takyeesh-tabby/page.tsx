...
export const metadata: Metadata = {
  title: "تكييش تابي | شرح معنى التكييش وكيف تبدأ | مطر",
  description:
    "صفحة تكييش تابي مخصصة لمن يبحث بهذه الصيغة العامية ويريد فهم الطريقة المناسبة لتحويل الرصيد إلى كاش بشكل واضح وسريع.",
  keywords:
  ...
  openGraph: {
    title: "تكييش تابي | شرح التكييش بطريقة واضحة | مطر",
    description: "تعرف على معنى تكييش تابي والطريقة المناسبة لتحويل الرصيد إلى كاش بخطوات واضحة.",
