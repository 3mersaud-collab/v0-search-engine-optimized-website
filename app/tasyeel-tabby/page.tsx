...
export const metadata: Metadata = {
  title: "تسييل تابي | نحوّل رصيدك نقد في حسابك خلال ساعة | مطر",
  description:
    "خدمة تسييل تابي مع مطر. ترسل شاشة تابي على واتساب، ونحوّل لك المبلغ الصافي مباشرة للحساب البنكي خلال ساعة. شفاف، سريع، وموثوق.",
  keywords:
  ...
  openGraph: {
    title: "تسييل تابي | نحوّل رصيدك نقد في حسابك خلال ساعة | مطر",
    description: "خدمة تسييل تابي مع مطر. ترسل شاشة تابي، ونحوّل لك المبلغ الصافي مباشرة للحساب البنكي خلال ساعة. شفاف، سريع، وموثوق.",
