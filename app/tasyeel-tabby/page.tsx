...
const whyTasyeel = [
  ...
  { icon: Clock, title: "ساعة واحدة فقط", desc: "من وقت دفع الدفعة الأولى حتى وصول المبلغ لحسابك البنكي." },
...
const faqs = [
  ...
  { q: "متى يصل المبلغ بعد التسييل؟", a: "خلال ساعة واحدة من دفع الدفعة الأولى. التحويل يصل لأي حساب بنكي سعودي." },
