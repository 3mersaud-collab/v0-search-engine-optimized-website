...
export const metadata: Metadata = {
  title: "تسييل تابي | شرح التسييل وتحويل الرصيد إلى كاش | مطر",
  description:
    "صفحة تسييل تابي تشرح معنى التسييل وكيفية تحويل الرصيد إلى كاش بخطوات واضحة ونظام شراكة منظم دون حشو أو تعقيد.",
  keywords:
    "تسييل تابي, معنى تسييل تابي, تحويل تابي إلى كاش, تحويل رصيد تابي كاش, تسييل رصيد تابي",
  alternates: {
    canonical: "https://liilsol.com/tasyeel-tabby",
  },
  openGraph: {
    title: "تسييل تابي | شرح تحويل الرصيد إلى كاش | مطر",
    description: "تعرف على معنى تسييل تابي والطريقة الواضحة لتحويل الرصيد إلى كاش يصل حسابك بسرعة.",
  ...
  "@graph": [
    {
      ...
      description: "صفحة متخصصة تشرح خدمة تسييل رصيد تابي وتحويله إلى كاش عبر نظام شراكة واضح.",
      provider: { "@type": "LocalBusiness", "@id": "https://liilsol.com/#business" },
      areaServed: { "@type": "Country", name: "Saudi Arabia" },
      serviceType: ["تسييل تابي", "شرح تحويل تابي إلى كاش", "تحويل رصيد تابي كاش"],
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
...
const faqs = [
  { q: "ما الفرق بين تسييل تابي وباقي المصطلحات الشائعة؟", a: "تسييل تابي هو الوصف الأوضح لعملية تحويل الرصيد في التطبيق إلى نقد. بعض العملاء يستخدمون مصطلحات أخرى مثل كاش تابي أو تكييش تابي، لكن هذه الصفحة مخصصة لشرح معنى التسييل نفسه." },
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed max-w-2xl mx-auto">
                ...
                <strong className="text-foreground"> تحويل تابي إلى كاش</strong> بخطوات واضحة حتى تفهم العملية وتعرف كيف يصل الصافي إلى حسابك البنكي بسرعة.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <Button size="lg" className="gap-2 text-lg shadow-lg shadow-primary/20" asChild>
                  <a href="https://wa.me/966590360039?text=أبي تسييل تابي" target="_blank" rel="noopener noreferrer">
                    سيّل رصيد تابي الآن
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none text-muted-foreground leading-relaxed space-y-5">
                ...
                <p>
                  كثير من الناس لديهم حد في تابي لا يستخدمونه لأنهم لا يحتاجون شراء منتجات. لكنهم يحتاجون سيولة نقدية لدفع إيجار، فاتورة، أو مصاريف طارئة. هنا يأتي دور <strong className="text-foreground">تسييل تابي</strong> كحل يشرح مسار تحويل الرصيد إلى نقد بشكل مفهوم.
                </p>
                <p>
