...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "تسييل رصيد تابي فوري. حوّل حدك الائتماني إلى نقد يصل حسابك خلال ساعة من دفع الدفعة الأولى.",
...
const whyTasyeel = [
  ...
  { icon: Clock, title: "تحويل خلال ساعة", desc: "خلال ساعة من دفع الدفعة الأولى حتى وصول المبلغ لحسابك البنكي." },
...
const faqs = [
  ...
  { q: "متى يصل المبلغ بعد التسييل؟", a: "خلال ساعة من دفع الدفعة الأولى. التحويل يصل لأي حساب بنكي سعودي. وفي حال التأخير نلتزم بتعويضك 25 ريال عن كل ساعة تأخير." },
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <Button size="lg" className="gap-2 text-lg shadow-lg shadow-primary/20" asChild>
                  <a href="https://wa.me/966544610485?text=أبي تسييل تابي" target="_blank" rel="noopener noreferrer">
                    سيّل رصيد تابي الآن
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
                تواصل معنا الآن عبر واتساب وسيّل رصيدك. المبلغ يصل حسابك البنكي خلال ساعة من دفع الدفعة الأولى.
              </p>
