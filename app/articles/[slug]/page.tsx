...
const articlesData: Record<string, {
  ...
  "siyola-tabby-guide": {
    ...
    description: "تعرف على خطوات الحصول على سيولة تابي وكيفية تحويل رصيدك إلى كاش نقدي في حسابك البنكي خلال ساعة من دفع الدفعة الأولى مع مطر.",
    category: "سيولة تابي",
    readTime: "5 دقائق",
    date: "2026-01-15",
...
سيولة تابي هي عملية تحويل الرصيد المتاح لك في تطبيق تابي (Tabby) إلى كاش نقدي يُحول مباشرة إلى حسابك البنكي خلال ساعة من دفع الدفعة الأولى. هذه الخدمة تساعدك على الاستفادة من حد الائتمان المتاح لديك في تابي للحصول على سيولة نقدية عند الحاجة.
...
نقوم نحن بإتمام كل شيء ونحول لك المبلغ خلال ساعة من دفع الدفعة الأولى.
...
- تنفيذ خلال ساعة من دفع الدفعة الأولى
