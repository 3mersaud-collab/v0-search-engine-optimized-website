...
ادخل موقع مطر (liilsol.com) واستخدم حاسبة السيولة لتحديد مبلغ الشراء ومعرفة المبلغ النهائي الذي ستستلمه بعد الخصومات.
...
- **واتساب**: 0590360039
- **البريد**: liilsol.support@liilsa.com
- **انستقرام**: @liilsa.sol
    `
  },
  "cash-tamara-steps": {
...
### الخطوة 1: احسب المبلغ في حاسبة السيولة
ادخل موقع مطر (liilsol.com) واستخدم الحاسبة لتحديد مبلغ الشراء.
...
- **صفحة البنك**: صور الشاشة وأرسلها لنا
- **رسالة خطأ**: صور رسالة الخطأ وأرسلها لنا
...
تمارا يتطلب التأكد من صلاحية الحد الائتماني بشكل مختلف عن تابي، لذلك نحتاج الوصول لصفحة البنك أو رسالة الخطأ للتأكد من نجاح العملية.
...
5. اضغط "ادفع"
6. صور صفحة البنك أو رسالة الخطأ
...
2. نشتري منتج بهذا الرصيد من متاجر مثل نون واكسترا والمنيع
3. نبيع المنتج بسعر السوق
4. نخصم الدفعة الأولى والرسوم الإدارية
5. نحول لك المتبقي كاش في حسابك
