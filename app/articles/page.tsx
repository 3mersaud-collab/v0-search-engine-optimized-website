...
const articles = [
  ...
  },
  {
    ...
    excerpt: "مقارنة شاملة بين سلفة تابي وسلفة تمارا و. تعرف على الفرق في الخطوات والمتاجر المتاحة.",
    category: "مقارنة",
    readTime: "7 دقائق",
    date: "2026-01-05",
  ...
  },
  {
    ...
    excerpt: "تعرف على المتاجر المتاحة لكل تطبيق: نون واكسترا لتابي وتمارا، و ل. روابط مباشرة.",
    category: "المتاجر",
    readTime: "4 دقائق",
    date: "2025-12-20",
    keywords: ["نون", "اكسترا", "", "متاجر سيولة"]
  },
  {
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none text-muted-foreground leading-relaxed space-y-4">
                ...
                <p>
                  سواء كنت تبحث عن <strong className="text-foreground">سلفة تابي</strong> أو <strong className="text-foreground">سلفة تمارا</strong> أو حتى كاش من ، مقالاتنا تشرح لك كل الخطوات بالتفصيل: من فحص الحد الائتماني، إلى اختيار المتجر المناسب (نون، اكسترا، أو )، وحتى استلام المبلغ في حسابك.
                </p>
                <p>
