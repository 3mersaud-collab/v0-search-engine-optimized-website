...
export const metadata: Metadata = {
  ...
  keywords: "سيولة تابي, سيولة تمارا, كاش تابي, كاش تمارا, سلفة تابي, سلفة تمارا, تحويل رصيد تابي, مقالات سيولة, مطر, liilsol",
  alternates: {
...
const articles = [
  {
    ...
    excerpt: "تعرف على خطوات الحصول على سيولة تابي وكيفية تحويل رصيدك إلى كاش نقدي في حسابك البنكي خلال ساعتين فقط.",
    category: "سيولة تابي",
    readTime: "5 دقائق",
    date: "2026-01-15",
        ...
        <section className="py-16 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
              تواصل معنا للحصول على سيولة تابي أو كاش تمارا خلال ساعتين فقط
            </p>
