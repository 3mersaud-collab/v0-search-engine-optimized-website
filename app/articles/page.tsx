...
const articles = [
  ...
  {
    id: "how-to-get-cash-tamara",
    title: "كيف اطلع كاش من تمارا؟ — خطوات موثقة 2026",
    excerpt: "دليل عملي بالخطوات الكاملة لكيفية إخراج كاش من تمارا مع تفصيل الخطوة الإضافية التي تختلف عن تابي.",
    category: "كاش تمارا",
    readTime: "5 دقائق",
    date: "2026-02-05",
    keywords: ["كيف اطلع كاش من تمارا", "كاش تمارا خطوات", "طريقة كاش تمارا"]
  },
  {
    id: "is-tasyeel-tabby-safe",
    title: "هل تسييل تابي آمن؟ — الحقيقة الكاملة",
    excerpt: "إجابة مباشرة وموثوقة عن سؤال: هل تسييل تابي آمن؟ مع علامات التحذير وكيف تحمي نفسك.",
    category: "أمان",
    readTime: "5 دقائق",
    date: "2026-02-10",
    keywords: ["هل تسييل تابي آمن", "تسييل تابي مضمون", "سيولة تابي بأمان"]
  },
  {
    id: "best-siyola-tabby-method",
    title: "أفضل طريقة لسيولة تابي في 2026",
    excerpt: "مقارنة عملية بين الخيارات المتاحة للحصول على سيولة تابي: نون أو اكسترا؟ وأي مبلغ يعطيك أفضل نتيجة؟",
    category: "سيولة تابي",
    readTime: "6 دقائق",
    date: "2026-02-15",
    keywords: ["أفضل طريقة سيولة تابي", "أفضل متجر سيولة تابي", "نصائح سيولة تابي"]
  },
  {
    id: "tabby-cash-amount",
    title: "كم يعطيني تابي كاش؟ — جدول حسابي بالأمثلة",
    excerpt: "أرقام حقيقية ودقيقة: كم ستستلم من كاش تابي حسب مبلغ رصيدك مع جدول مفصل لمبالغ مختلفة.",
    category: "سيولة تابي",
    readTime: "4 دقائق",
    date: "2026-02-20",
    keywords: ["كم يعطيني تابي كاش", "حساب كاش تابي", "مبلغ سيولة تابي"]
  },
  {
    id: "siyola-tamara-no-salary",
    title: "سيولة تمارا بدون تحويل راتب — هل ممكن؟",
    excerpt: "الجواب المباشر لمن يسأل عن سيولة تمارا بدون ربط راتب. تعرف على شرط الحصول الوحيد.",
    category: "سيولة تمارا",
    readTime: "4 دقائق",
    date: "2026-02-25",
    keywords: ["سيولة تمارا بدون تحويل راتب", "كاش تمارا بدون راتب", "تمارا للعاطلين"]
  },
  {
    id: "cash-tabby-vs-tasyeel-tabby",
    title: "الفرق بين كاش تابي وتسييل تابي — شرح مبسط",
    excerpt: "هل كاش تابي وتسييل تابي وتكييش تابي نفس الشيء؟ جدول واضح يشرح الفرق في المصطلحات والخدمة.",
    category: "سيولة تابي",
    readTime: "4 دقائق",
    date: "2026-03-01",
    keywords: ["الفرق بين كاش تابي وتسييل تابي", "كاش تابي أم تسييل تابي", "تكييش تابي فرق"]
  }
]
