          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <a href="https://wa.me/966575506660" className="text-muted-foreground hover:text-foreground transition-colors" dir="ltr" target="_blank" rel="noopener noreferrer">تواصل عبر واتساب</a>
              </a>
