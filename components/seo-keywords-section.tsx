...
const stats = [
  ...
  { icon: Shield, value: "4.7", label: "تقييم Google" },
  { icon: Banknote, value: "+2M", label: "ريال تم تحويلها" },
]
          ...
          <div className="bg-card rounded-2xl p-8 border border-border shadow-lg">
            ...
            <div className="prose prose-lg text-muted-foreground leading-relaxed space-y-4">
              ...
              <p>
                ...
                تواصل معنا على <a href="https://wa.me/966568037324" className="text-foreground font-bold hover:underline" target="_blank" rel="noopener noreferrer">واتساب</a> للحصول على أفضل خدمة سيولة وسلفة.
              </p>
            </div>
          </div>
        </div>
