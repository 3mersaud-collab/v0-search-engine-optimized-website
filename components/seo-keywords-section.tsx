      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            نقدم جميع خدمات السيولة والتسييل من تابي وتمارا و. اختر الخدمة المناسبة لك واحصل على الكاش خلال ساعة.
          </p>
        </div>
          ...
          <div className="bg-card rounded-2xl p-8 border border-border shadow-lg">
            ...
            <div className="prose prose-lg text-muted-foreground leading-relaxed space-y-4">
              <p>
                ...
                <strong className="text-foreground"> تابي وتمارا و</strong>. نتكفل بقيمة الدفعة الأولى مقابل نسبة الشراكة، ثم نقوم ببيع الجهاز وتحويل مبلغ السيولة أو السلفة المطلوب مباشرة لحسابكم البنكي.
              </p>
              <p>
