...
const faqs = [
  ...
  },
  {
    ...
    answer: "لتابي: ادخل نون أو اكسترا، اختر منتجات بالمبلغ المطلوب، اختر تابي كوسيلة دفع، بعد ظهور تقسيم الدفعات صور الشاشة وأرسلها لنا على واتساب 05755 06660. لتمارا: نفس الخطوات لكن بعد اختيار تمارا، أضف بطاقة بنكية بدون رصيد واضغط ادفع، ثم صور الشاشة وأرسلها لنا."
  },
  {
  ...
  },
  {
    ...
    answer: "نحوّل الكاش لحسابك البنكي خلال ساعة من دفع الدفعة الأولى، وفي حال التأخير نلتزم بتعويضك 25 ريال عن كل ساعة تأخير. نعمل على مدار الساعة لضمان سرعة الخدمة."
  },
  {
  ...
  },
  {
    ...
    answer: "الحد الأدنى للسيولة هو 1,000 ريال والحد الأقصى يعتمد على الرصيد المتاح لديك في تابي أو تمارا أو مدفوع. للمبالغ الكبيرة، تواصل معنا على 05755 06660."
  },
  {
  ...
  },
  {
    ...
    answer: "واتساب: 05755 06660 | هاتف: 05755 06660 | بريد: matar@m6rsa.com | انستقرام: @m6r.sa | الموقع: الرياض - حي المرسلات. نرد على جميع الاستفسارات خلال دقائق."
  }
]
