...
const faqs = [
  ...
  },
  {
    ...
    answer: "نعم، خدمتنا آمنة 100% وشفافة. ندخل معكم كشركاء في شراء الجهاز ونتكفل بالدفعة الأولى مقابل نسبة الشراكة، وبهذا نتجنب شبهات الربا ونحقق بإذن الله التورق المباح شرعاً. لا نفتيكم لكن هذا ما توصلنا له باجتهادنا وبحثنا في الأحكام الشرعية. عملية الشراء تتم من خلالك مباشرة عبر التطبيق الرسمي، ولا نطلب كلمات مرور أو بيانات حساسة."
  },
  {
