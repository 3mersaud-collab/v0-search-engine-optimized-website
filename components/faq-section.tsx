...
const faqs = [
  {
    ...
    answer: "نقوم بالدخول كشركاء معكم في شراء الجهاز عبر تابي وتمارا، ونتكفل بقيمة الدفعة الأولى مقابل نسبة الشراكة، ثم نبيع الجهاز ونحول لكم مبلغ السيولة أو السلفة المطلوب مباشرة لحسابكم البنكي خلال ساعة. تختار المبلغ من حاسبة السيولة، تدخل المتجر (نون أو اكسترا لتابي وتمارا،  ل)، تضيف منتجات بالمبلغ المطلوب، تصور الشاشة بعد اختيار طريقة الدفع، وترسلها لنا."
  },
  {
    question: "كيف أحصل على كاش تابي أو كاش تمارا؟",
    answer: "لتابي: ادخل نون أو اكسترا، اختر منتجات بالمبلغ المطلوب، اختر تابي كوسيلة دفع، بعد ظهور تقسيم الدفعات صور الشاشة وأرسلها لنا على واتساب 0590360039. لتمارا: نفس الخطوات لكن بعد اختيار تمارا، أضف بطاقة بنكية بدون رصيد واضغط ادفع، ثم صور الشاشة وأرسلها لنا."
  },
  {
    question: "ما هي المتاجر المتاحة لخدمة السيولة؟",
    answer: "تابي وتمارا متاحين في متجر نون ومتجر اكسترا.  متاح في متجر  فقط. نوفر روابط مباشرة للمتاجر في صفحة فحص الحد الائتماني."
  },
  {
  ...
  },
  {
    ...
    answer: "الحد الأدنى للسيولة هو 1,000 ريال والحد الأقصى يعتمد على الرصيد المتاح لديك في تابي أو تمارا. للمبالغ الكبيرة، تواصل معنا على 0590360039."
  },
  {
  ...
  },
  {
    ...
    answer: "تابي و: بعد اختيارهم كوسيلة دفع وظهور تقسيم الدفعات، فقط صور الشاشة وأرسلها. تمارا: يجب إكمال الخطوات وإضافة بطاقة بنكية بدون رصيد والضغط على ادفع، ثم تصوير الشاشة. مهم: لا تستخدم Apple Pay أو بطاقة فيها رصيد مع تمارا."
  },
  {
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">
              إجابات على الأسئلة الأكثر شيوعاً حول خدمات السيولة والسلفة والكاش من تابي وتمارا و
            </p>
          </div>
