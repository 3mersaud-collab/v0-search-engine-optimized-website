export function SeoSchema() {
  const organizationSchema = {
    ...
    "description": "خدمة سيولة تابي وكاش تمارا وسلفة تابي وسلفة تمارا وتسييل وتكييش الرصيد في السعودية عبر نظام شراكة واضح. ندخل مع العميل في شراء الجهاز عبر تابي أو تمارا أو مدفوع، ثم نبيع الجهاز ونحوّل الصافي إلى الحساب البنكي.",
  ...
  const serviceSchema = {
    ...
    "name": "سيولة تابي وكاش تمارا وسلفة وتسييل الرصيد",
    "description": "ندخل مع العميل كشركاء في شراء الجهاز عبر تابي أو تمارا أو مدفوع، ونتكفل بالدفعة الأولى بحسب الخطة، ثم نبيع الجهاز ونحوّل صافي المبلغ إلى الحساب البنكي، مع صفحات متخصصة لكل نية بحث مثل السيولة والسلفة والكاش والتكييش والتسييل.",
    "provider": {
      "@type": "LocalBusiness",
      "@id": "https://liilsol.com/#business"
    },
      ...
      "itemListElement": [
        {
          ...
          "itemOffered": {
            "@type": "Service",
            "name": "سيولة تابي",
            "alternateName": ["كاش تابي", "تسييل تابي", "تحويل تابي إلى كاش", "سلفة تابي", "تكييش تابي"],
        ...
        },
        {
          ...
          "itemOffered": {
            "@type": "Service",
            "name": "كاش تمارا",
            "alternateName": ["سيولة تمارا", "سلفة تمارا", "تحويل رصيد تمارا", "تحويل تمارا إلى كاش"],
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "ادخل أحد المتاجر المتاحة، أضف منتجاً بالمبلغ المطلوب، اختر تابي كوسيلة دفع، وبعد ظهور تقسيم الدفعات صوّر الشاشة وأرسلها لنا على واتساب 0590360039. بعد إكمال الخطوات نحوّل الصافي إلى حسابك البنكي."
        }
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "يتم تحويل المبلغ لحسابك البنكي غالباً خلال ساعة من اكتمال الخطوات وإرسال صورة الشاشة عبر الواتساب، مع اختلاف الصفحة المناسبة حسب عبارة البحث مثل سيولة تابي أو كاش تمارا أو سلفة تمارا."
        }
      },
      {
        "@type": "Question",
  ...
  const websiteSchema = {
    ...
    "alternateName": ["مطر", "سحابة غيث ماحسبت حسابها", "سيولة تابي", "كاش تمارا", "سلفة تابي", "سلفة تمارا", "تسييل تابي", "تكييش تابي"],
    "url": "https://liilsol.com",
    "description": "سيولة تابي وكاش تمارا ومدفوع مع حاسبة للصافي وإكمال الطلب عبر الواتساب. الموقع يغطي أيضاً سلفة تابي وسلفة تمارا والتسييل والتكييش والسيولة بدون بنك بنظام شراكة واضح.",
    "inLanguage": "ar-SA",
    "publisher": {
      "@type": "Organization",
      "@id": "https://liilsol.com/#business"
