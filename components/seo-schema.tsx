export function SeoSchema() {
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "نقوم بتحويل المبلغ لحسابك البنكي خلال ساعة فقط من استلام صورة الشاشة وموافقتك على العملية."
        }
      },
      {
        "@type": "Question",
  ...
  const websiteSchema = {
    ...
    "url": "https://liilsol.com",
    "description": "سيولة تابي وتمارا ومدفوع - كاش فوري من رصيدك خلال ساعة. أفضل خدمة سيولة في السعودية.",
    "inLanguage": "ar-SA",
    "publisher": {
      "@type": "Organization",
      "@id": "https://liilsol.com/#business"
