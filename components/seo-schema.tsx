  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "ادخل متجر نون أو اكسترا، أضف منتجات بالمبلغ المطلوب، اختر تمارا كوسيلة دفع، أضف بطاقة بنكية بدون رصيد (لا تستخدم Apple Pay أو بطاقة برصيد)، اضغط ادفع، وصور الشاشة سواء ظهرت صفحة البنك أو رسالة خطأ وأرسلها لنا."
        }
      },
      {
        "@type": "Question",
