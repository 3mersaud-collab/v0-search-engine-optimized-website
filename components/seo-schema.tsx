    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "ادخل متجر نون أو اكسترا، أضف منتجات بالمبلغ المطلوب، اختر تابي كوسيلة دفع، وبعد ظهور تقسيم الدفعات صور الشاشة وأرسلها لنا على واتساب 0567130112. نحول الكاش لحسابك خلال ساعة."
        }
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "الحسبة والشرح متاحة داخل الموقع، أما إكمال الطلب والتأكيد النهائي فيتم عبر الواتساب مباشرة على الرقم 0567130112."
        }
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "تواصل معنا عبر واتساب على الرقم 0567130112 أو البريد الإلكتروني matar@liilsa.com. نحن متاحين 24/7."
        }
      }
    ]
  }
