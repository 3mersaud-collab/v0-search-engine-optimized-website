...
export function ContactSection() {
  ...
  const whatsappUrl = `https://api.whatsapp.com/send/?phone=966567130112&text=${whatsappMsg}&type=phone_number&app_absent=0`
              ...
              <div className="space-y-5 mb-8">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground" dir="ltr">+966 56 713 0112</p>
                  </div>
                </a>
