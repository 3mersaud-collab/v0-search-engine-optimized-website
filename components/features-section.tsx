...
const features = [
  ...
  },
  {
    ...
    description: "نحوّل لك السيولة النقدية خلال ساعة من دفع الدفعة الأولى. سلفة فورية لحسابك البنكي مباشرة بعد إتمام عملية الشراكة.",
    footnote: "المدة تقريبية وقد تختلف حسب اوقات معالجة البنوك"
  },
  {
    icon: Headphones,
    title: "دعم واتساب متواصل",
    description: "فريق دعم مطر متاح على 05755 06660 للاجابة على جميع استفساراتك حول سيولة تابي وكاش تمارا وتحويل جوالات الى كاش."
  },
  {
    icon: BadgeCheck,
  ...
  },
  {
    ...
    description: "رسوم إدارية 10% (+ 100 ر.س للمبالغ أقل من 4,000 ر.س) بدون أي رسوم مخفية. ندخل معكم كشركاء وجميع الأرقام محسوبة مسبقاً في الحاسبة.",
