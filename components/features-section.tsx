...
const features = [
  ...
  },
  {
    ...
    description: "نحول لك السيولة النقدية عادة خلال ساعتين. سلفة فورية لحسابك البنكي مباشرة بعد اتمام عملية الشراكة.",
  ...
  },
  {
    ...
    description: "ندخل كشركاء معكم عبر تابي وتمارا ومدفوع. سيولة تابي، كاش تمارا، او سيولة مدفوع - اختر التطبيق المناسب لك للحصول على سلفة فورية."
  },
  {
    icon: TrendingUp,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            نقدم افضل خدمة سيولة نقدية وسلفة فورية في السعودية بدخولنا معكم كشركاء في شراء الجهاز عبر تابي وتمارا ومدفوع
          </p>
        </div>
